...
path('module_instructor/<int:module_id>/resources/<int:resource_id>/', views.resource_detail, name='resource_detail'),
path('module_instructor/<int:module_id>/resources/<int:resource_id>/update/', views.edit_resource_instructor, name='edit_resource_instructor'),
path('module_instructor/<int:module_id>/resources/<int:resource_id>/delete/', views.delete_resource_instructor, name='delete_resource_instructor'),
path('module_instructor/<int:module_id>/resources/', views.list_resources, name='list_resources'),
